...
class MStructureObj:
    def __init__(self, data, species, num_monomer_rules, num_cluster_rules, num_j_rules, aust_tol):
        data = data.split()
        self.num_cluster_rules = num_cluster_rules
        self.num_j_rules = num_j_rules
        self.num_monomer_rules = num_monomer_rules
        ...
        self.Monomer_sums = [0.0] * num_monomer_rules
        self.basis = []
